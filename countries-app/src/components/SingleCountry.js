          ...
          >
            ...
            <article className="flex flex-col md:flex-row gap-8">
              ...
              <ul className="my-4 flex flex-col items-start justify-start gap-2 text-slate-700 dark:text-gray-400">
                ...
                <li>Timezone: {item.timezones[0]}</li>
            ...
            { item.borders && (
              ...
              <Link to="/" className="mt-8 inline-block bg-white text-gray-700  px-6 py-2 rounded shadow hover:bg-slate-200 transition-all-duration-200 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-400">&larr; Back</Link>
            </article>
          </div>
        ))}
      </section>
